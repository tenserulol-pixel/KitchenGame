...
public class Player : MonoBehaviour,IKitchenObjectParent
{
    ...
    private void HandleCuttingHold()
    {
    // Используем gameInput (поле класса с маленькой буквы) вместо GameInput.Instance
    bool isHoldingKey = gameInput.IsInteractAlternatePressed(); 

    if (selectedCounter != null && selectedCounter is CuttingCounter cuttingCounter)
    {
        cuttingCounter.SetCuttingState(isHoldingKey);
    }
    }
